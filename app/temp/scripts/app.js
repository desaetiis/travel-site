...
var MobileMenu = function () {
    function MobileMenu() {
        ...
        this.menuIcon = (0, _jquery2.default)(".site-header__menu-icon"); //targeting the icon
            ...
            this.itemsToReveal.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler() {
                        (0, _jquery2.default)(currentItem).addClass("reveal-item--is-visible"); //the action
                    },
...
var Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function keyPressHandler(e) {
            if (e.keyCode == 27) {
                //listen for keyUp on Escape Key
                this.closeModal();
            }
        }
    }, {
